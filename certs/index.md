...
* **Offensive Security Wireless Professional (OSWP)** — [Offensive Security](https://www.offensive-security.com/){:target="_blank" rel="noopener"}
* **Certified Red Team Professional (CRTP)** — [Pentester Academy](https://www.pentesteracademy.com/activedirectorylab){:target="_blank" rel="noopener"}
...
* **SEC549: Cloud Security Architecture** — [SANS](https://www.sans.org/cyber-security-courses/cloud-security-architecture){:target="_blank" rel="noopener"}
* **SEC540: Cloud Security and DevSecOps Automation** — [SANS](https://www.sans.org/cyber-security-courses/cloud-security-devsecops-automation/){:target="_blank" rel="noopener"}
* Breaching The Cloud Perimeter (4-Hours) — [BLACK HILLS Information Security](https://www.blackhillsinfosec.com/){:target="_blank" rel="noopener"}
* Foundations of Operationalizing MITRE ATT&CK — [AttackIQ](https://academy.attackiq.com/){:target="_blank" rel="noopener"}
...
* Carbon Black Response Administration Training — [Carbon Black](https://www.carbonblack.com/){:target="_blank" rel="noopener"}
* Carbon Black Response Advanced Administration Training — [Carbon Black](https://www.carbonblack.com/){:target="_blank" rel="noopener"}
* Carbon Black Response Advanced Analyst Training — [Carbon Black](https://www.carbonblack.com/){:target="_blank" rel="noopener"}
...
* WiFi Hacking: Wireless Penetration Testing for Beginners — [Udemy](https://www.udemy.com/user/jason-dion/){:target="_blank" rel="noopener"}
* Learn Wi-Fi Password Penetration Testing (WEP/WPA/WPA2) — [Udemy](https://www.udemy.com/user/zaidsabih/){:target="_blank" rel="noopener"}

#### **Social Engineering, Web & General Cybersecurity**

* Social Engineering, OSINT & Malware for Hacking — [Udemy](https://www.udemy.com/user/muharrem-aydin-2/){:target="_blank" rel="noopener"}
* Risk Management for Cybersecurity and IT Managers — [Udemy](https://www.udemy.com/user/jason-dion/){:target="_blank" rel="noopener"}
* Web hacking and Security — [Udemy](https://www.udemy.com/user/infysec-2/){:target="_blank" rel="noopener"}
* Master Microsoft PowerShell — [Udemy](https://www.udemy.com/user/techmountainconsulting/){:target="_blank" rel="noopener"}
...
* The Science of Leadership — [Udemy](https://www.udemy.com/user/gregorycaremans/){:target="_blank" rel="noopener"}
* Confident Body Language - Master Non Verbal Communication — [Udemy](https://www.udemy.com/user/jimmynaraine/){:target="_blank" rel="noopener"}